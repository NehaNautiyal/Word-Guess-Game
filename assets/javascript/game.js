$(function () {
    ...
    var hints = {
        ...
        oxygen: "Electron configuration ends in 2p4",
        nitrogen: "Electron configuration ends in 2p3",
                ...
                var matchLetter = function (randomLetter) {
                    ...
                    if (letterMatch === false) {
                        ...
                        if (wrongLetters.includes(usersLetter)) {
                            alert("You have already guessed the letter: " + usersLetter + ". Pick another letter");
                        } else {
